...
const Dashboard = () => {
    ...
    return (
        <>
            <Navbar />
            <h1 className='text-4xl font-bold text-blue5 m-8'>Welcome, {localStorage.getItem('name')} </h1>
                    ...
                    <div className='flex flex-wrap justify-center items-center h-1/2 w-screen '>
                        ...
                        <div className='flex flex-col gap-10 justify-between items-center h-full m-10'>
                            <div className='flex flex-col justify-center items-center w-[290px] h-1/2 rounded-lg shadow-xl py-20 px-5 cursor-pointer	' onClick={() => navigate('/schedule-visit ')}>
                                <h1 className='text-xl font-bold'>Schecule Visit</h1>
                            </div>
                            <div className='flex flex-col justify-center items-center w-[290px] h-1/2 rounded-lg shadow-xl py-20 px-5 cursor-pointer	' onClick={() => navigate('/view-visits')} >
                                <h1 className='text-xl font-bold'>Your Visitors List</h1>
                            </div>
                        </div>
